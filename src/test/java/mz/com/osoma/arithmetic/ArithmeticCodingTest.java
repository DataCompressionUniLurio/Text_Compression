...
/**
 * Tests the compression and decompression of a complete arithmetic coding
 * application, using the JUnit test framework.
 */
...
//    }
    ...
    private void test(byte[] b) {
        try {
            ...
            System.out.println("b size ="+b.length+" compressed size="+compressed.length);
